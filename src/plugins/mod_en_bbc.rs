...
fn extract_unique_id_from_url(url: &str) -> String {
    // Numeric part from URL like /news/12345678
    if let Ok(re) = Regex::new(r"/news/(\d+)") {
...
mod tests {
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://www.bbc.com/news/12345678";
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.bbc.com/sport/football/12345678"));
        assert_eq!(1, 1);
    }
}
