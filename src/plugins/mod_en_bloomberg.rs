...
// Plugin for Bloomberg news website
...
const PUBLISHER_NAME: &str = "Bloomberg";
const BASE_URL: &str = "https://www.bloomberg.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.bloomberg.com/markets", "markets"),
...
mod tests {
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://www.bloomberg.com/news/articles/2024-01-01/some-article-slug";
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.bloomberg.com/video/something"));
        assert_eq!(1, 1);
    }
}
