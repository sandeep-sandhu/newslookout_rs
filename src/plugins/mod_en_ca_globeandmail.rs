...
// Plugin for The Globe and Mail (theglobeandmail.com)
...
const PUBLISHER_NAME: &str = "The Globe and Mail";
const BASE_URL: &str = "https://www.theglobeandmail.com";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.theglobeandmail.com/canada/", "canada"),
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    // G&M article URLs have article-XXXXXXX pattern or date pattern
    url.contains("theglobeandmail.com/") && url.len() > 50
        && (url.contains("/article") || url.contains("/20"))
}
...
mod tests {
    ...
    fn test_extract_unique_id() {
        let url = "https://www.theglobeandmail.com/canada/article-canada-us-trade-talks-2024/";
        let id = extract_unique_id_from_url(url);
        assert_eq!(id, "article-canada-us-trade-talks-2024");
    }

    #[test]
    fn test_is_valid_requires_article_or_date() {
        assert!(!is_valid_article_url("https://www.theglobeandmail.com/canada/short/"));
    }

    #[test]
    fn test_is_valid_accepts_article_url() {
        assert!(is_valid_article_url(
            "https://www.theglobeandmail.com/canada/article-canada-us-trade-talks-2024/"
        ));
    }

    #[test]
    fn test_is_valid_accepts_date_url() {
        assert!(is_valid_article_url(
            "https://www.theglobeandmail.com/politics/2024/03/10/federal-budget-highlights/"
        ));
    }
    ...
    fn test_is_valid_rejects_newsletter() {
        assert!(!is_valid_article_url(
            "https://www.theglobeandmail.com/newsletter/morning-update/"
        ));
    }
}
