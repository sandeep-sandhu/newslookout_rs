...
// Plugin for Chicago Tribune (chicagotribune.com)
...
const PUBLISHER_NAME: &str = "Chicago Tribune";
const BASE_URL: &str = "https://www.chicagotribune.com";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.chicagotribune.com/news/", "news"),
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    url.contains("chicagotribune.com/") && url.len() > 45 && url.contains("/20")
}
...
mod tests {
    ...
    fn test_extract_unique_id() {
        let url = "https://www.chicagotribune.com/news/2024/03/10/chicago-mayor-budget-proposal";
        let id = extract_unique_id_from_url(url);
        assert_eq!(id, "chicago-mayor-budget-proposal");
    }

    #[test]
    fn test_is_valid_accepts_dated_article() {
        assert!(is_valid_article_url(
            "https://www.chicagotribune.com/news/2024/03/10/chicago-mayor-budget-proposal"
        ));
    }

    #[test]
    fn test_is_valid_rejects_short_url() {
        assert!(!is_valid_article_url("https://www.chicagotribune.com/news/"));
    }

    #[test]
    fn test_is_valid_rejects_video() {
        assert!(!is_valid_article_url(
            "https://www.chicagotribune.com/video/2024/03/10/some-video-clip"
        ));
    }

    #[test]
    fn test_is_valid_rejects_sports() {
        assert!(!is_valid_article_url(
            "https://www.chicagotribune.com/sports/2024/03/10/cubs-spring-training"
        ));
    }
}
