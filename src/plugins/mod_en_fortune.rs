...
// Plugin for Fortune (fortune.com)
...
const PUBLISHER_NAME: &str = "Fortune";
const BASE_URL: &str = "https://fortune.com";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://fortune.com/section/finance/", "finance"),
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    // Fortune articles have /YYYY/ in URL
    url.contains("fortune.com/") && url.contains("/20") && url.len() > 40
}

fn extract_unique_id_from_url(url: &str) -> String {
    // Fortune article URLs end with slug as the last path segment
...
mod tests {
    ...
    fn test_extract_unique_id() {
        let url = "https://fortune.com/2024/03/15/some-article-slug/";
    ...
    fn test_is_valid_requires_date() {
        assert!(!is_valid_article_url("https://fortune.com/section/finance/"));
    }

    #[test]
    fn test_is_valid_accepts_dated_article() {
        assert!(is_valid_article_url(
            "https://fortune.com/2024/03/15/some-long-article-slug-here/"
        ));
    }
    ...
    fn test_is_valid_rejects_video() {
        assert!(!is_valid_article_url(
            "https://fortune.com/video/2024/03/15/some-video/"
        ));
    }
    ...
    fn test_is_valid_rejects_newsletter() {
        assert!(!is_valid_article_url(
            "https://fortune.com/newsletters/the-broadsheet/"
        ));
    }
}
