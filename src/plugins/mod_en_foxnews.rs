...
// Plugin for Fox News (foxnews.com)
...
const PUBLISHER_NAME: &str = "Fox News";
const BASE_URL: &str = "https://www.foxnews.com";
...
const SKIP_URL_PATTERNS: &[&str] = &[
    "/video/", "/category/", "/person/", "#", "javascript:", "mailto:",
...
fn extract_unique_id_from_url(url: &str) -> String {
    // Fox News article URLs end with slug: /politics/article-slug
...
mod tests {
    ...
    fn test_extract_unique_id() {
        let url = "https://www.foxnews.com/politics/some-long-article-slug-here";
        let id = extract_unique_id_from_url(url);
        assert_eq!(id, "some-long-article-slug-here");
    }

    #[test]
    fn test_is_valid_accepts_politics_article() {
        assert!(is_valid_article_url(
            "https://www.foxnews.com/politics/some-long-article-slug-here"
        ));
    }
    ...
    fn test_is_valid_rejects_video() {
        assert!(!is_valid_article_url(
            "https://www.foxnews.com/video/12345678"
        ));
    }
    ...
    fn test_is_valid_rejects_short_url() {
        assert!(!is_valid_article_url(
            "https://www.foxnews.com/politics/short"
        ));
    }

    #[test]
    fn test_is_valid_rejects_shows() {
        assert!(!is_valid_article_url(
