...
// Plugin for The Guardian news website
...
const PUBLISHER_NAME: &str = "The Guardian";
const BASE_URL: &str = "https://www.theguardian.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.theguardian.com/world", "world"),
...
mod tests {
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://www.theguardian.com/business/2024/jan/01/some-article-slug";
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.theguardian.com/sport/something"));
        assert_eq!(1, 1);
    }
}
