...
// Plugin for The Guardian Nigeria (guardian.ng)
...
const PUBLISHER_NAME: &str = "The Guardian Nigeria";
const BASE_URL: &str = "https://guardian.ng/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://guardian.ng/news/", "news"),
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    // Guardian NG article URLs are at least 4 path segments deep
...
mod tests {
    ...
    fn test_is_valid_accepts_article() {
        assert!(is_valid_article_url(
            "https://guardian.ng/news/nigeria/politics/president-tinubu-policy-speech/"
        ));
    }

    #[test]
    fn test_is_valid_rejects_section() {
        assert!(!is_valid_article_url("https://guardian.ng/news/"));
    }

    #[test]
    fn test_extract_uid_slug() {
        let url = "https://guardian.ng/news/nigeria/politics/president-tinubu-policy-speech/";
        let id = extract_unique_id_from_url(url);
        assert_eq!(id, "president-tinubu-policy-speech");
    }
}
