...
// Plugin for Forbes India news website
...
const PUBLISHER_NAME: &str = "Forbes India";
const BASE_URL: &str = "https://www.forbesindia.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.forbesindia.com/", "main"),
];
...
fn extract_unique_id_from_url(url: &str) -> String {
    // Numeric part (4+ digits) from URL
...
mod tests {
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://www.forbesindia.com/article/leaderboard/some-story/12345/1";
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.forbesindia.com/video/something"));
        assert_eq!(1, 1);
    }
}
