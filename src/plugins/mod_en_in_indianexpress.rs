...
// Plugin for Indian Express news website
...
const PUBLISHER_NAME: &str = "Indian Express";
const BASE_URL: &str = "https://indianexpress.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://indianexpress.com/section/business/", "business"),
...
mod tests {
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://indianexpress.com/article/business/some-article-12345678/";
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://indianexpress.com/section/business/"));
        assert!(is_valid_article_url("https://indianexpress.com/article/business/some-story-12345678/"));
        assert_eq!(1, 1);
    }
}
