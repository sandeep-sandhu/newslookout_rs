...
// Plugin for Money Control news website
...
const PUBLISHER_NAME: &str = "Money Control";
const BASE_URL: &str = "https://www.moneycontrol.com/";
...
fn extract_unique_id_from_url(url: &str) -> String {
    ...
    if let Ok(re) = Regex::new(r"(\d{5,})(?:[^/\d]*)$") {
...
fn extract_article_body_with_css(html: &str) -> Option<String> {
    ...
    let selectors = [
        // Format 1
        "div[itemprop='mainContentOfPage'] div[class*='Normal']",
        // Format 2
        "article[class*='artData'] div[class*='artText']",
        // Format 3
...
mod tests {
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.moneycontrol.com/video/something"));
        assert!(is_valid_article_url("https://www.moneycontrol.com/news/business/some-article-12345.html"));
        assert_eq!(1, 1);
    }

    #[test]
    fn test_extract_unique_id_from_url() {
        let url = "https://www.moneycontrol.com/news/business/some-article-12345678.html";
