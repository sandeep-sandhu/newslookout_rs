...
// NDTV — thin SiteConfig delegating to the generic html_news retriever.
...
static SITE: SiteConfig = SiteConfig {
    ...
    starter_urls: &[("https://www.ndtv.com/business", "business"),
    ("https://www.ndtv.com/india-news", "india")],
    valid_url_patterns: &["www.ndtv.com/"],
    skip_url_patterns: &["/about", "/contact", "/subscribe", "/login", "/video/",
    "/photo/", "/podcast/", "/newsletter", "/live-update",
    "#", "javascript:", "mailto:", "/topic/"],
    body_selectors: &["div[itemprop='articleBody']", "div[class*='story__content']", "div.story-content", "article p"],
    id_regexes: &[r"(\d{5,})(?:[^/]*)$"],
