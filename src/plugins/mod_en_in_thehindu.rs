...
// Plugin for The Hindu news website
...
const PUBLISHER_NAME: &str = "The Hindu";
const BASE_URL: &str = "https://www.thehindu.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.thehindu.com/business/", "business"),
...
fn extract_unique_id_from_url(url: &str) -> String {
    // Extract numeric ID like /article12345678.ece
    if let Ok(re) = Regex::new(r"article(\d{5,})") {
...
mod tests {
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.thehindu.com/about"));
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://www.thehindu.com/business/article12345678.ece";
