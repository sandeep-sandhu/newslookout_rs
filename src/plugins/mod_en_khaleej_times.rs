...
// Plugin for Khaleej Times (khaleejtimes.com)
...
const PUBLISHER_NAME: &str = "Khaleej Times";
const BASE_URL: &str = "https://www.khaleejtimes.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.khaleejtimes.com/business/", "business"),
    ("https://www.khaleejtimes.com/uae/", "uae"),
    ("https://www.khaleejtimes.com/world/", "world"),
];

const SKIP_URL_PATTERNS: &[&str] = &[
    "/photos/", "/videos/", "/sports/", "/entertainment/",
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    // Must have article-level path depth
...
mod tests {
    ...
    #[test]
    fn test_is_valid_accepts_business_article() {
        assert!(is_valid_article_url(
            "https://www.khaleejtimes.com/business/economy/uae-growth-forecast-2024"
        ));
    }

    #[test]
    fn test_is_valid_rejects_top_level() {
        assert!(!is_valid_article_url("https://www.khaleejtimes.com/business/"));
    }

    #[test]
    fn test_extract_uid_slug() {
        let url = "https://www.khaleejtimes.com/uae/some-article-slug";
