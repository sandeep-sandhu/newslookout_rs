...
// MarketWatch — thin SiteConfig delegating to the generic html_news retriever.
...
static SITE: SiteConfig = SiteConfig {
    ...
    starter_urls: &[("https://www.marketwatch.com/economy-politics/", "economy"),
    ("https://www.marketwatch.com/investing/", "investing"),
    ("https://www.marketwatch.com/markets/", "markets")],
    valid_url_patterns: &["marketwatch.com/story/",
    "marketwatch.com/articles/"],
    skip_url_patterns: &["/video/", "#", "javascript:", "mailto:",
    "/newsletters/", "/tools/"],
    body_selectors: &["div.article__body p", "div[class*='article-body'] p", "div.article-wrap p", "article p", "main p"],
    id_regexes: &[],
