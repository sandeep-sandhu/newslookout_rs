// file: mod_en_reuters.rs
// Reuters — thin SiteConfig delegating to the generic html_news retriever.
...
pub const PLUGIN_NAME: &str = "mod_en_reuters";
...
static SITE: SiteConfig = SiteConfig {
    ...
    starter_urls: &[("https://www.reuters.com/business/", "business"),
    ("https://www.reuters.com/world/", "world")],
    valid_url_patterns: &["www.reuters.com/"],
    skip_url_patterns: &["/about", "/contact", "/subscribe", "/login", "/video/",
    "/picture/", "/podcast/", "/newsletter", "/live-report/",
    "#", "javascript:", "mailto:", "/graphics/"],
    body_selectors: &["div[class*='article-body']", "div[data-testid='paragraph']", "article p", "div.StandardArticleBody_body p"],
    id_regexes: &[],
