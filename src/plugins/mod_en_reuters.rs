...
// Plugin for Reuters news website
...
const PUBLISHER_NAME: &str = "Reuters";
const BASE_URL: &str = "https://www.reuters.com/";
...
mod tests {
    ...
    fn test_extract_unique_id_from_url() {
        let url = "https://www.reuters.com/business/finance/some-article-slug-2024-01-01/";
    ...
    fn test_is_valid_article_url() {
        assert!(!is_valid_article_url("https://www.reuters.com/video/something"));
        assert_eq!(1, 1);
    }
}
