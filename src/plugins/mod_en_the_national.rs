...
// Plugin for The National (UAE) – thenationalnews.com
...
const PUBLISHER_NAME: &str = "The National";
const BASE_URL: &str = "https://www.thenationalnews.com/";
const MIN_CONTENT_LENGTH: usize = 400;

const STARTER_URLS: &[(&str, &str)] = &[
    ("https://www.thenationalnews.com/business/", "business"),
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    // The National article URLs have slug depth >= 4 path segments
...
mod tests {
    ...
    #[test]
    fn test_is_valid_accepts_deep_article() {
        assert!(is_valid_article_url(
            "https://www.thenationalnews.com/business/economy/2024/03/10/uae-gdp-growth-outlook"
        ));
    }

    #[test]
    fn test_is_valid_rejects_section_page() {
        assert!(!is_valid_article_url("https://www.thenationalnews.com/business/"));
    }

    #[test]
    fn test_extract_uid_is_last_slug() {
        let url = "https://www.thenationalnews.com/business/economy/2024/03/10/uae-gdp-growth-outlook";
        let id = extract_unique_id_from_url(url);
        assert_eq!(id, "uae-gdp-growth-outlook");
    }
}
