...
// Plugin for The Verge (theverge.com)
...
fn is_valid_article_url(url: &str) -> bool {
    ...
    // The Verge article URLs have date: /YYYY/M/D/
    url.contains("theverge.com/") && url.contains("/20") && url.len() > 45
}

fn extract_unique_id_from_url(url: &str) -> String {
    // The Verge article URLs end with slug as last path segment
...
fn extract_article_body_with_css(html: &str) -> Option<String> {
    ...
    let selectors = [
        "div[class*='duet--article--article-body'] p",
...
mod tests {
    ...
    fn test_extract_unique_id() {
        let url = "https://www.theverge.com/2024/3/10/some-article-slug";
    ...
    fn test_is_valid_requires_date() {
        assert!(!is_valid_article_url("https://www.theverge.com/tech/some-page/"));
    }

    #[test]
    fn test_is_valid_accepts_dated_article() {
        assert!(is_valid_article_url(
            "https://www.theverge.com/2024/3/10/23931234/some-article-slug-here"
        ));
    }
    ...
    fn test_is_valid_rejects_video() {
        assert!(!is_valid_article_url(
            "https://www.theverge.com/video/2024/1/10/some-video"
        ));
    }

    #[test]
    fn test_is_valid_rejects_forums() {
        assert!(!is_valid_article_url(
            "https://www.theverge.com/forums/2024/1/10/some-thread"
        ));
    }
}
