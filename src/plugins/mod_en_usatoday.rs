...
// USA Today — thin SiteConfig delegating to the generic html_news retriever.
...
static SITE: SiteConfig = SiteConfig {
    ...
    starter_urls: &[("https://www.usatoday.com/news/", "news"),
    ("https://www.usatoday.com/news/politics/", "politics"),
    ("https://www.usatoday.com/money/", "money")],
    valid_url_patterns: &["usatoday.com/story/"],
    skip_url_patterns: &["/picture-gallery/", "/videos/", "#", "javascript:", "mailto:",
    "/newsletter/", "/sports/"],
    body_selectors: &["div[class*='article-body'] p", "div.gnt_ar_b p", "article p", "div[class*='storyBody'] p", "main p"],
    id_regexes: &[],
