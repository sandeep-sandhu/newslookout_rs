...
// The Washington Post — thin SiteConfig delegating to the generic html_news retriever.
...
static SITE: SiteConfig = SiteConfig {
    ...
    starter_urls: &[("https://www.washingtonpost.com/world/", "world"),
    ("https://www.washingtonpost.com/politics/", "politics"),
    ("https://www.washingtonpost.com/business/", "business")],
    valid_url_patterns: &["washingtonpost.com/"],
    skip_url_patterns: &["/video/", "/podcasts/", "#", "javascript:", "mailto:",
    "/newsletters/", "/graphics/", "/live-updates/"],
    body_selectors: &["div[class*='article-body'] p", "div[class*='teaser-content'] p", "article p", "div.wpds-c p", "main p"],
    id_regexes: &[],
